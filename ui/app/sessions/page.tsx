      ...
      actions={
        <div className="flex items-center gap-2">
          <input
            ...
            className="w-64 rounded-lg border border-white/10 bg-black/40 px-3 py-1.5 text-sm text-white placeholder:text-slate-500"
          />
          <select
            value={String(limit)}
          ...
          <table className="w-full text-sm">
            <thead className="bg-black/30 text-left text-xs uppercase tracking-wide text-slate-300">
              <tr>
                ...
                <th className="px-4 py-3">Dport</th>
                <th className="px-4 py-3">Mark</th>
                <th className="px-4 py-3">Assured</th>
            ...
            <tbody>
              {filtered.map((e, idx) => (
                <tr key={`${e.proto}-${e.src}-${e.sport}-${e.dst}-${e.dport}-${idx}`} className="border-t border-white/5">
                  ...
                  <td className="px-4 py-3 text-right">
                    <button
                      ...
                      className={
                        canKill
                          ? "rounded-lg border border-rose-500/30 bg-rose-500/10 px-3 py-1 text-xs text-rose-200 hover:bg-rose-500/20"
